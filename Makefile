# Derived from https://github.com/monmohan/logdriver/blob/master/plugin/Makefile
# Plugin parameters
PLUGIN_NAME=jspaulsen/ingest-driver
PLUGIN_TAG=v1
...
build-image:
	...
	docker build -f Dockerfile.build --target plugin -t ${PLUGIN_NAME}:rootfsimg .
